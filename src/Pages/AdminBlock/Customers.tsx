...
const Userspage = () => {
  ...
  const handledeluser =async(userid:any)=>{
    try {
      ...
      if (confirmed) {
        await axios.delete(`http://192.168.0.149:4000/user/${userid}`);
  ...
  return (
    <div>
      ...
      <div className="userbg">
        ...
        <button className="adduserbtn" onClick={handleAdduser}>Add customer</button>
        {isuserpopupOpen&&(
          <>
